![Banner](https://i.imgur.com/Ks5IcqC.jpg)
...
[![Discord](https://discordapp.com/api/guilds/421170296004018177/widget.json)](https://discord.gg/cpMkxRP) 
...
- Fixed bug where lolibot would not have up to date settings at times.
...
- Fixed the biggest bugs of LoliBot. Fun and CustomCommands where ordered the wrong way in the cog loader, and the GSSP cog's class being called "GaySoundsShitposting" which is just disgusting.
...
###### Boring Stuff
- LoliBot has been ported over to the 1.0 version of discord.py. Meaning that she will actually be upto date with new discord changes for once. This also means that there is quite a few new features and bug fixes with this version. 
...
- NSFW channels can now be added to selectively enable LoliBot's NSFW features.
...
- Fixed twitch cog bug that made lolibot crash a lot
...
## Licence
[MIT Licence](https://github.com/Aiyumii/KawaiiSoup/blob/master/LICENSE)
